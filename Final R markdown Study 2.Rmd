...
plot_country <- plot_grid(H2B_plot_Country)

save_plot("H2B_Plot_country.pdf", plot = plot_country)
...
## complex theorized preregistered model, further evidence of good 
## fit can be seen in the normally distributed and uniform residuals.
## Meteyard & Davies, (2020) & Nezlek, (2008) 
