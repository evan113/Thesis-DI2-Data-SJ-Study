...
b_path <- lmer(System_Justification ~ 1 + Life_Satisfaction + WellinSociety+ age + Gender2 +
                       (1|Country), data = H1C_H4B_DATA, REML = F,
               control = lmerControl(optimizer = "bobyqa"))
...
visualize(H1C_Full_model, plot = "model",
 ...
 flexplot(System_Justification~WellinSociety + Life_Satisfaction,
         data = H1C_H4B_DATA, se = FALSE, method = "lm", sample = 100)
 ...
 ## Sobel test 
 library(multilevel)
 sobel(H1C_H4B_DATA$WellinSociety, H1C_H4B_DATA$Life_Satisfaction,
       H1C_H4B_DATA$System_Justification)
