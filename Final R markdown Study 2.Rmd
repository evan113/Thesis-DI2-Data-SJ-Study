...
H1_A_and_B_income <- lmer(System_Justification ~ 1 + income_centered +
(1 + income_centered | Country),
                   data = INCOMECLEAN2, REML = F)

H1_A_and_B_education <- lmer(System_Justification ~ 1 + education_centered +
(1 + education_centered | Country),
                   data = INCOMECLEAN2, REML = F)
summary(H1_A_and_B_income)
summary(H1_A_and_B_education)

## building a table for both h1a and h1b
tab_model(H1_A_and_B_income, H1_A_and_B_education, file = "H1A_B_model.doc")

## Visualize random effects in H1 A and B
plot_h1a_b_1  <- visualize(H1_A_and_B_income, plot = "model",
          formula = System_Justification~income_centered + Country,
          sample = 42) 

plot_h1a_b_2 <- visualize(H1_A_and_B_education, plot = "model",
...
H2A <- lmer(System_Justification ~ 1 + PolOrientation_centered +
...
H2B_base_model <- lmer(System_Justification ~ 1 + PolOrientation_centered  +
                    (1 + PolOrientation_centered | Country), data = INCOMECLEAN5)

## Setting reference level for pol party in power
reference_level <- "Right"
INCOMECLEAN5$polpartypower_fac <- relevel(INCOMECLEAN5$polpartypower_fac,
                                          ref = reference_level)

H2B_Moderation_model <- lmer(System_Justification ~ 1 + PolOrientation_centered + 
                                     polpartypower_fac + 
...
tab_model(H2A, H2B_Moderation_model, file = "H2A_B_Model.doc")
```
...
H3A <- lmer(System_Justification ~ 1 + GINI + 
                    (1 | Region),  data = INCOMECLEAN)
summary(H3A)
tab_model(H3A)
visualize(H3A, plot = "model",
          formula = System_Justification~GINI + Region, sample = 10)
...
H3B_base_model <- lmer(System_Justification ~ 1 + GINI +  
                    (1 | Region),  data = INCOMECLEAN)
...
visualize(H3B_Moderation_Model, plot = "model",
          formula = System_Justification~Social_Mobility + Region | GINI,
          sample = 10)
...
```{r}
## Hypothesis 3A - Economic inequality predicting SJ
H3A_Country <- lmer(System_Justification ~ 1 + GINI + 
                    (1 | Country),  data = INCOMECLEAN)
summary(H3A_Country)
tab_model(H3A_Country)
visualize(H3A_Country, plot = "model",
          formula = System_Justification~GINI + Country, sample = 42)

visualize(H3A_Country, plot = "residuals")
## Hypothesis 3B

H3B_base_model_Country <- lmer(System_Justification ~ 1 + GINI +  
                    (1 | Country),  data = INCOMECLEAN)

H3B_Moderation_Model_Country <- lmer(System_Justification ~ 1 + GINI*Social_Mobility +
                                     (1 | Country), data = INCOMECLEAN)
summary(H3B_Moderation_Model_Country)
tab_model(H3B_Moderation_Model_Country)
visualize(H3B_Moderation_Model_Country, plot = "model",
          formula = System_Justification~Social_Mobility + Country | GINI,
          sample = 42)

## Building table for H3A and B at region level
tab_model(H3A_Country, H3B_Moderation_Model_Country, file = "H3A_B_Country_Model.doc")
```
...
H4A_4B_Country_model <- lmer(System_Justification ~ 1 + Freedom + (1 | Country),
               data = INCOMECLEAN)
summary(H4A_4B_Country_model)
tab_model(H4A_4B_Country_model)
visualize(H4A_4B_Country_model, plot = "model",
          sample = 42)
...
```{r}
## H4A & H4B - Freedom predicting SJ at Country level
H4A_4B_Region_model <- lmer(System_Justification ~ 1 + Freedom + (1 | Region),
               data = INCOMECLEAN)
summary(H4A_4B_Region_model)
tab_model(H4A_4B_Region_model)
visualize(H4A_4B_Region_model, plot = "model",
          sample = 10)
